#Student number ;R00150748
#Name ; David Hurley

#These are my global lists that i need to reference threwout the program
...
#this function reads in from the file and converts to a list
def reading():
    fo = open('bank.txt')
    list = []
    for line in fo:
...
#this function is for opening accounts
def opening_account():
    import random
    import math
...
#this function is for closing accounts
...
#this function is for withdrawing money from an account
def withdraw_money():
...
#this function is for depositiing money from an account
def deposit_money():
    account_search = input("please enter your account number")
    if account_search in account_number:
