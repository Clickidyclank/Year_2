...
def menu():
    ...
    accounts, balance, names, str1 = load_data(file,accounts,balance,names,str1)
    print(accounts)
    ...
    while True:
        ...
        if users_input == 6:
            ...
            accounts, balance, names, str1 = open_account(accounts, balance, names, file,str1)

        elif users_input == 2:
            close_account(accounts, names, balance, file, str1)

        elif users_input ==3:
            withdraw_money(accounts, balance)
    ...
    close_bank_file(accounts, balance, names)


#takes in the accounts, balance and names list and will write the information
#into the bank.txt file as a list called str1
def close_bank_file(accounts, balance, names):
    f = open("bank.txt" , "a")
    strl = create_list(accounts, balance,names)
    for i in range(len(accounts)):
        f.write((strl[i][0] + " " + str(strl[i][1]) + " " + strl[i][2]) + "\n")
...
def load_data(file, accounts, balance, name, str1):
    f= open(file, "r+")
    line = f.readline()
    ...
    try:
        ...
        while True:
            ...
            account_number, bal, name = create_list(accounts, balance, names)
        return accounts, balance, name, str1
...
def open_account(accounts, balance, name,file, str1):
...
def close_account(accounts, name, balance, file, str1):
    account_number_input = read_nonnegative_integer("Please insert your account number: ")
    ...
    del accounts[position]
    del balance[position]
    del name[position]
   # str1.append(line.split)
